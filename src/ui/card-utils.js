...
export function cardTempSuitNum(card, suit, number, elementUtil) {
	...
	/*●*/
	if(snnode){
	    if(lib.config.extension_十周年UI_cardPrettify=='gold') snnode.setBackgroundImage("extension/十周年UI/zq/image/card-base/viewsuitnum.webp");
	    else if(lib.config.extension_十周年UI_cardPrettify=='decade') snnode.setBackgroundImage("extension/十周年UI/zq/image/card-base/viewsuitnum.png");
	    else snnode.setBackgroundImage("extension/十周年UI/zq/image/card-base/viewsuitnum.jpg");
	}
...
export function getShaEffectKey(nature, card) {
	const natureKeyMap = { thunder: "effect_leisha", fire: "effect_huosha", ice: "effect_bingsha", kami: "effect_shesha" };/*●*/
