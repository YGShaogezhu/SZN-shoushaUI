...
export function playerSetSkillYinYang(skill, isYang) {
	if(typeof $setSkillYinYang == 'function') game.broadcastAll((player, skill, isYang) => player.$setSkillYinYang(skill, isYang), this, skill, isYang);/*●*/
}
...
export function playerSetSkillState(skill, state) {
	if(typeof $setSkillState == 'function') game.broadcastAll((player, skill, state) => player.$setSkillState(skill, state), this, skill, state);/*●*/
}
