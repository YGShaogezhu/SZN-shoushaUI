...
export function onNewDecadeStyleClick(control) {
	...
	game.saveConfig("extension_十周年UI_newDecadeStyle", control);
                    ...
                    /*●*/
                    if (lib.config.extension_十周年UI_newDecadeStyle == 'off') {/*●手杀*/
                        ...
                        game.saveConfig('extension_十周年UI_jindutiaoSet', '27');
                        game.saveConfig('extension_十周年UI_loadingStyle', 'othersOn');
                        game.saveConfig('extension_十周年UI_cardPrompt', true);
                        game.saveConfig("show_round_menu", false);
                        game.saveConfig("show_log", "center");
                        game.saveConfig("clear_log", true);
					} else {/*●十周年，名将*/
                        game.saveConfig('extension_十周年UI_cardPrettify', 'decade');
                        game.saveConfig('extension_十周年UI_JDTSYangshi', '2');
                        game.saveConfig('extension_十周年UI_jindutiaoYangshi', '3');
                        game.saveConfig('extension_十周年UI_jindutiaoSet', '28');
                        game.saveConfig('extension_十周年UI_loadingStyle', 'othersOff');
                        game.saveConfig('extension_十周年UI_cardPrompt', false);
                        game.saveConfig("show_round_menu", true);
                        game.saveConfig("show_log", "off");
					}
					if (lib.config.extension_十周年UI_newDecadeStyle == 'onlineUI') {
                        game.saveConfig('extension_十周年UI_cardPrettify', 'online');
                        game.saveConfig('extension_十周年UI_JDTSYangshi', '3');
                        game.saveConfig('extension_十周年UI_jindutiaoYangshi', '2');
                        game.saveConfig('extension_十周年UI_jindutiaoSet', '26');
                        game.saveConfig('extension_十周年UI_loadingStyle', 'onlineUI');
					}
					if (lib.config.extension_十周年UI_newDecadeStyle == 'othersOff') {/*●一将*/
                        game.saveConfig('extension_十周年UI_cardPrettify', 'caise');
                        game.saveConfig('extension_十周年UI_jindutiaoYangshi', '4');
                        game.saveConfig('extension_十周年UI_jindutiaoSet', '27');
					}
					if (lib.config.extension_十周年UI_newDecadeStyle == 'babysha') {
                        game.saveConfig('extension_十周年UI_cardPrettify', 'bingkele');
                        game.saveConfig('extension_十周年UI_JDTSYangshi', '4');
                        game.saveConfig('extension_十周年UI_jindutiaoSet', '27');
					}
